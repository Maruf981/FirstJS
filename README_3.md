...
### 4. <span style="color: lightgreen;">concat()</span>
...
### 5. <span style="color: lightgreen;">trim()</span>
...
### 6. <span style="color: lightgreen;">includes()</span>
...
### 11. <span style="color: lightgreen;">supstring()</span>
