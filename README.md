...
Стрелочные функции представляют собой более краткий синтаксис для создания функций. Они не имеют собственного контекста `this`, что делает их удобными для работы с функциями, где нужно сохранить контекст внешней функции.

## 5. IIFE (Immediately Invoked Function Expression)

IIFE — это функция, которая сразу же выполняется после её объявления. Она часто используется для изоляции кода и предотвращения загрязнения глобальной области видимости.
...
![JS Logo](https://upload.wikimedia.org/wikipedia/commons/6/64/JavaScript-logo.png)
