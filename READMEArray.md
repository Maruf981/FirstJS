...
**Spread Syntax** (оператор «распаковки») в JavaScript позволяет развернуть элементы массива, объекта или другого итеративного объекта в местах, где ожидаются отдельные элементы. Это удобный инструмент для работы с коллекциями данных.
